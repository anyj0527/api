...
/******************************************************************************************
 ******************** Backport extension for Tizen 7.0 ************************************
 ******************************************************************************************/
...
// #define ml_information_destroy ml_option_destroy
// #define ml_information_get ml_option_get
// #define _ml_information_set ml_option_set
// #define _ml_information_create ml_option_create
 ...
 * @param[in,out] user_data Private data for the callback.
 */
